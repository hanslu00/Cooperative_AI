...
if __name__ == '__main__':
    ...
    env = UnityEnvironment(file_name="../dynamic_environment/DynamicEnvironment1", seed=args.seed, side_channels=[channel], worker_id = 3786)
    ...
    load_state_dicts_for_team_required_grad_false(purple_networks, ["dyn_agent5/ppo1/actor_A10.pth", "dyn_agent5/ppo1/actor_B10.pth"], ["dyn_agent5/ppo1/critic_A10.pth", "dyn_agent5/ppo1/critic_B10.pth"])
    load_state_dicts_for_team_required_grad_true(blue_networks, ["dyn_agent5/ppo1/actor_A10.pth", "dyn_agent5/ppo1/actor_B10.pth"], ["dyn_agent5/ppo1/critic_A10.pth", "dyn_agent5/ppo1/critic_B10.pth"])
