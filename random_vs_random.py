...
if __name__ == '__main__':
    ...
    for ep in range(1, n_episodes+1):
        ...
        # for i in range(2):
            set_random_action_for_team(env, team_blue)
        ...
        if ep % 100 == 0:
            ...
            with open(f"{SAVE_PATH}/dyn_average_reward_per_100.csv", mode='w', newline='') as file:
                csvwriter = csv.writer(file)
                csvwriter.writerow(avg_reward_100)

        if ep % 100 == 0:
            highest_streak_100.append(highest_streak)
            with open(f"{SAVE_PATH}/dyn_highest_streak_per_100.csv", mode='w', newline='') as file:
                csvwriter = csv.writer(file)
